...
<div className="agent-quickstart-actions">
  <button
    ...
    data-copy-url="https://raw.githubusercontent.com/rissets/skills/main/skills/quickstart/SKILL.md"
  ...
  <button
    type="button"
    className="agent-quickstart-action"
    data-copy-text="npx skills add rissets/skills -s quickstart"
    data-copy-success="Install command copied"
  >
    <span className="agent-quickstart-action-title">Install quickstart skill</span>
    <span className="agent-quickstart-action-description">Copy the command to install <code>quickstart</code> from <code>rissets/skills</code>.</span>
  </button>
</div>
