...
```text
https://composio.rissets.com/mcp
```

Use your environment API key as `Authorization: Bearer <NANGO-API-KEY>`.

## Skills

Nango's public skills live in [rissets/skills](https://github.com/rissets/skills).

Install the core skill to implement Nango integration functions:

```bash
npx skills add rissets/skills -s building-nango-functions
```
...
| Tool | URL | Use it for |
| --- | --- | --- |
| Docs MCP server | `https://composio.rissets.com/mcp` | Live docs context inside coding agents. |
