...
<div className="agent-quickstart-actions">
  <button
    ...
    data-copy-text="npx skills add rissets/skills -s building-nango-functions-locally"
...
<Steps>
  ...
  <Step id="configure-api-keys" title="Configure API keys">
    ...
    <Accordion title="For agents">
      ...
      For additional context while building, add Nango's documentation MCP server (`https://composio.rissets.com/mcp`) and install the local builder skill:

      ```bash
      npx skills add rissets/skills -s building-nango-functions-locally
      ```
    </Accordion>
  </Step>
...
<div className="agent-quickstart-actions">
  <button
    type="button"
    className="agent-quickstart-action"
    data-copy-text="npx skills add rissets/skills -s building-nango-functions-remotely"
    data-copy-success="Install command copied"
  >
